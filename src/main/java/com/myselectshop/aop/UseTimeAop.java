...
public class UseTimeAop {
    ...
    @Pointcut("execution(* com.myselectshop.domain.myshop.controller.ProductController.*(..))")
    private void product() {}
    @Pointcut("execution(* com.myselectshop.domain.folder.controller.FolderController.*(..))")
    private void folder() {}
    @Pointcut("execution(* com.myselectshop.domain.naver.controller.NaverApiController.*(..))")
    private void naver() {}
